...
def main() -> None:
    ...
    print()
    print("CSV referentni genom")
    print("→ k-mer/minimizer indeks")
    print("→ sekvencijalno poravnanje")
    print("→ slični istorijski regioni")
    print("→ De Bruijn graf nastavaka")
    print("→ Hidden Markov režimi")
    print("→ Bajesov variant calling")
    print("→ sužavanje prostora na relevantne kandidate")
    print("→ sastavljanje i ocenjivanje NEXT sedmorke")
    print("→ stroga hronološka walk-forward validacija")
    print("→ zamrznuta holdout provera")

    rezultat = obradi_igru(
        naziv="Loto",
        csv_putanja=ZAJEDNICKI_CSV,
        seed_pomeraj=0,
    )
...
Težine modela:
  Genomski k-mer nastavci           17.98%
  De Bruijn graf                    31.77%
  Hidden Markov režimi              33.83%
  Bajesov variant calling           16.42%
